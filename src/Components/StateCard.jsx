...
const StateCard = ({label,value=1200 ,bcolor="border-l-accent"}) => {
  return (
    <div
      className={`w-37.5 h-17.5 liquid-special flex flex-col items-start px-4 justify-center rounded-2xl border  border-white/10 border-l-4 ${bcolor} font-poppins gap-1 `}
    >
